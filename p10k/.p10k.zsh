# Generated by Powerlevel10k configuration wizard on 2022-08-23 at 15:47 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_ASDF_RUST_FOREGROUND=3
  ...
  typeset -g POWERLEVEL9K_TERRAFORM_VERSION_FOREGROUND=13
  # Custom icon.
